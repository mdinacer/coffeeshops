...
namespace API.Extensions
{
    public static class HistoryExtensions
    {
        ...
        public static IQueryable<HistoryElementDto> Filter(this IQueryable<HistoryElementDto> query, string? userId, DateTime? startDate, DateTime? endDate, ShopEntityType? type, ShopEntityAction? action)
        {
