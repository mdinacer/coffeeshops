...
namespace API.Extensions
{
    public static class TransactionExtensions
    {
        ...
        public static IQueryable<MoneyTransaction> Filter(this IQueryable<MoneyTransaction> query, TransactionType? type, TransactionDirection? direction, DateTime? startDate, DateTime? endDate)
        {
            if (direction != null)
            ...
            if (endDate != null)
            { query = query.Where(p => p.Date <= endDate.Value.Date.AddHours(24)); }
