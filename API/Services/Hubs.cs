...
namespace API.Services
{
    public class Hubs : Hub
    {
        ...
        public async Task AddToGroup(string groupName)
        {
            ...
            await Clients.OthersInGroup(groupName).SendAsync("ReceiveMessage", $"{Context.User?.Identity?.Name ?? Context.ConnectionId} vient de se connecter.");
        }
        ...
        public async Task RemoveFromGroup(string groupName)
        {
            ...
            await Clients.OthersInGroup(groupName).SendAsync("ReceiveMessage", $"{Context.User?.Identity?.Name ?? Context.ConnectionId} vient de se déconnecter.");
        }
