"use strict";
(self.webpackChunkclient = self.webpackChunkclient || []).push([[609], {
    9998: function (e, n) {
        n.Z = function (e, n) {
            if (e && n) {
                var t = Array.isArray(n) ? n : n.split(","), r = e.name || "", o = (e.type || "").toLowerCase(),
                    i = o.replace(/\/.*$/, "");
        ...
        var r = t(2791), o = t(2007), i = t.n(o), a = t(9388),
        ...
        function u(e, n) {
            var t = function (e) {
                ...
                if (n && -1 !== n.lastIndexOf(".") && !e.type) {
                    var t = n.split(".").pop().toLowerCase(), r = c.get(t);
        ...
        function f(e) {
            return m(e.target.files).map((function (e) {
                return u(e)
            }))
        }
        ...
        function d(e, n) {
            return (0, a.mG)(this, void 0, void 0, (function () {
                ...
                return (0, a.Jh)(this, (function (r) {
                    switch (r.label) {
                        case 0:
                            return e.items ? (t = m(e.items).filter((function (e) {
                                return "file" === e.kind
                            })), "drop" !== n ? [2, t] : [4, Promise.all(t.map(g))]) : [3, 2];
                        case 1:
                            return [2, v(y(r.sent()))];
                        case 2:
                            return [2, v(m(e.files).map((function (e) {
                                return u(e)
                            })))]
                    }
                }))
        ...
        function y(e) {
            return e.reduce((function (e, n) {
                return (0, a.ev)((0, a.ev)([], (0, a.CR)(e), !1), (0, a.CR)(Array.isArray(n) ? y(n) : [n]), !1)
            }), [])
        }
        ...
        function k(e, n) {
            if (e) {
                ...
                return "Object" === t && e.constructor && (t = e.constructor.name), "Map" === t || "Set" === t ? Array.from(e) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? P(e, n) : void 0
            }
        }
        ...
        var C = "file-invalid-type", S = "file-too-large", z = "file-too-small", R = "too-many-files",
            I = function (e) {
                e = Array.isArray(e) && 1 === e.length ? e[0] : e;
                var n = Array.isArray(e) ? "one of ".concat(e.join(", ")) : e;
                return {code: C, message: "File type must be ".concat(n)}
            }, M = function (e) {
                return {code: S, message: "File is larger than ".concat(e, " ").concat(1 === e ? "byte" : "bytes")}
            }, T = function (e) {
                return {code: z, message: "File is smaller than ".concat(e, " ").concat(1 === e ? "byte" : "bytes")}
        ...
        function K(e, n, t) {
            if (_(e.size)) if (_(n) && _(t)) {
                if (e.size > t) return [!1, M(t)];
                if (e.size < n) return [!1, T(n)]
            } else {
                if (_(n) && e.size < n) return [!1, T(n)];
                if (_(t) && e.size > t) return [!1, M(t)]
            }
            return [!0, null]
        }
        ...
        function G(e) {
            var n = e.files, t = e.accept, r = e.minSize, o = e.maxSize, i = e.multiple, a = e.maxFiles,
                c = e.validator;
            return !(!i && n.length > 1 || i && a >= 1 && n.length > a) && n.every((function (e) {
                var n = F(B(e, t), 1)[0], i = F(K(e, r, o), 1)[0], a = c ? c(e) : null;
                return n && i && !a
            }))
        }
        ...
        function q() {
            ...
            return function (e) {
                ...
                return n.some((function (n) {
                    return !J(e) && n && n.apply(void 0, [e].concat(r)), J(e)
                }))
            }
        }
        ...
        function Y(e) {
            if (_(e)) return Object.entries(e).reduce((function (e, n) {
                var t = F(n, 2), r = t[0], o = t[1];
        ...
        var ve = (0, r.forwardRef)((function (e, n) {
            var t = e.children, o = ye(de(e, te)), i = o.open, a = de(o, re);
            return (0, r.useImperativeHandle)(n, (function () {
                return {open: i}
            }), [i]), r.createElement(r.Fragment, null, t(fe(fe({}, a), {}, {open: i})))
        }));
        ve.displayName = "Dropzone";
        var me = {
            disabled: !1,
        ...
        ve.defaultProps = me, ve.propTypes = {
            children: i().func,
        ...
        function ye() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = fe(fe({}, me), e),
                t = n.accept, o = n.disabled, i = n.getFilesFromEvent, a = n.maxSize, c = n.minSize, u = n.multiple,
                l = n.maxFiles, s = n.onDragEnter, f = n.onDragLeave, p = n.onDragOver, d = n.onDrop,
                v = n.onDropAccepted, m = n.onDropRejected, g = n.onFileDialogCancel, y = n.onFileDialogOpen,
                b = n.useFsAccessApi, h = n.autoFocus, w = n.preventDropOnDocument, D = n.noClick, O = n.noKeyboard,
                x = n.noDrag, j = n.noDragEventsBubbling, A = n.onError, E = n.validator,
                F = (0, r.useMemo)((function () {
                    return Y(t)
                }), [t]), k = (0, r.useMemo)((function () {
                    return V(t)
                }), [t]), P = (0, r.useMemo)((function () {
                    return "function" === typeof y ? y : he
                }), [y]), C = (0, r.useMemo)((function () {
                    return "function" === typeof g ? g : he
                }), [g]), S = (0, r.useRef)(null), z = (0, r.useRef)(null), R = (0, r.useReducer)(be, ge), I = ce(R, 2),
                M = I[0], T = I[1], _ = M.isFocused, $ = M.isFileDialogActive,
                W = (0, r.useRef)("undefined" !== typeof window && window.isSecureContext && b && N()),
                ee = function () {
                    !W.current && $ && setTimeout((function () {
                        z.current && (z.current.files.length || (T({type: "closeDialog"}), C()))
                    }), 300)
                };
            ...
            var ne = (0, r.useRef)([]), te = function (e) {
                S.current && S.current.contains(e.target) || (e.preventDefault(), ne.current = [])
            };
            (0, r.useEffect)((function () {
                return w && (document.addEventListener("dragover", U, !1), document.addEventListener("drop", te, !1)), function () {
                    w && (document.removeEventListener("dragover", U), document.removeEventListener("drop", te))
                }
            }), [S, w]), (0, r.useEffect)((function () {
                return !o && h && S.current && S.current.focus(), function () {
                }
            }), [S, h, o]);
            var re = (0, r.useCallback)((function (e) {
                A ? A(e) : console.error(e)
            }), [A]), ue = (0, r.useCallback)((function (e) {
                e.preventDefault(), e.persist(), ke(e), ne.current = [].concat(ae(ne.current), [e.target]), H(e) && Promise.resolve(i(e)).then((function (n) {
                    if (!J(e) || j) {
                        var t = n.length, r = t > 0 && G({
                            files: n,
                            accept: F,
                            minSize: c,
                            maxSize: a,
            ...
            }), [i, s, re, j, F, c, a, u, l, E]), le = (0, r.useCallback)((function (e) {
                ...
                return n && p && p(e), !1
            }), [p, j]), se = (0, r.useCallback)((function (e) {
                e.preventDefault(), e.persist(), ke(e);
                var n = ne.current.filter((function (e) {
                    return S.current && S.current.contains(e)
                })), t = n.indexOf(e.target);
                -1 !== t && n.splice(t, 1), ne.current = n, n.length > 0 || (T({
                    type: "setDraggedFiles",
                    isDragActive: !1,
                    isDragAccept: !1,
                    isDragReject: !1
                }), H(e) && f && f(e))
            }), [S, f, j]), ve = (0, r.useCallback)((function (e, n) {
                var t = [], r = [];
                e.forEach((function (e) {
                    var n = ce(B(e, F), 2), o = n[0], i = n[1], u = ce(K(e, c, a), 2), l = u[0], s = u[1],
                        f = E ? E(e) : null;
                    if (o && l && !f) t.push(e); else {
                        var p = [i, s];
                        f && (p = p.concat(f)), r.push({
                            file: e, errors: p.filter((function (e) {
                                return e
                            }))
                        })
                    }
            ...
            }), [T, u, F, c, a, l, d, v, m, E]), ye = (0, r.useCallback)((function (e) {
                e.preventDefault(), e.persist(), ke(e), ne.current = [], H(e) && Promise.resolve(i(e)).then((function (n) {
                    J(e) && !j || ve(n, e)
                })).catch((function (e) {
                    return re(e)
                })), T({type: "reset"})
            }), [i, ve, re, j]), we = (0, r.useCallback)((function () {
                if (W.current) {
                    T({type: "openDialog"}), P();
                    ...
                    window.showOpenFilePicker(e).then((function (e) {
                        ...
                        ve(e, null), T({type: "closeDialog"})
                    })).catch((function (e) {
                        Q(e) ? (C(e), T({type: "closeDialog"})) : X(e) ? (W.current = !1, z.current ? (z.current.value = null, z.current.click()) : re(new Error("Cannot open the file picker because the https://developer.mozilla.org/en-US/docs/Web/API/File_System_Access_API is not supported and no <input> was provided."))) : re(e)
                    }))
                } else z.current && (T({type: "openDialog"}), P(), z.current.value = null, z.current.click())
            }), [T, P, C, b, ve, re, k, u]), De = (0, r.useCallback)((function (e) {
                S.current && S.current.isEqualNode(e.target) && (" " !== e.key && "Enter" !== e.key && 32 !== e.keyCode && 13 !== e.keyCode || (e.preventDefault(), we()))
            }), [S, we]), Oe = (0, r.useCallback)((function () {
                T({type: "focus"})
            }), []), xe = (0, r.useCallback)((function () {
                T({type: "blur"})
            }), []), je = (0, r.useCallback)((function () {
                D || (Z() ? setTimeout(we, 0) : we())
            }), [D, we]), Ae = function (e) {
                return o ? null : e
            }, Ee = function (e) {
                return O ? null : Ae(e)
                ...
                return function () {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = e.refKey,
                        t = void 0 === n ? "ref" : n, r = e.role, i = e.onKeyDown, a = e.onFocus, c = e.onBlur,
                        u = e.onClick, l = e.onDragEnter, s = e.onDragOver, f = e.onDragLeave, p = e.onDrop,
                        d = de(e, oe);
                    return fe(fe(pe({
                        onKeyDown: Ee(q(i, De)),
                        onFocus: Ee(q(a, Oe)),
                        onBlur: Ee(q(c, xe)),
                        onClick: Ae(q(u, je)),
                        onDragEnter: Fe(q(l, ue)),
                        onDragOver: Fe(q(s, le)),
                        onDragLeave: Fe(q(f, se)),
                        onDrop: Fe(q(p, ye)),
                        role: "string" === typeof r && "" !== r ? r : "presentation"
                    }, t, S), o || O ? {} : {tabIndex: 0}), d)
                }
            }), [S, De, Oe, xe, je, ue, le, se, ye, O, x, o]), Ce = (0, r.useCallback)((function (e) {
                e.stopPropagation()
            }), []), Se = (0, r.useMemo)((function () {
                return function () {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = e.refKey,
                        t = void 0 === n ? "ref" : n, r = e.onChange, o = e.onClick, i = de(e, ie), a = pe({
                            accept: F,
                            multiple: u,
                            type: "file",
                            style: {display: "none"},
        ...
        function be(e, n) {
            switch (n.type) {
                case"focus":
                    return fe(fe({}, e), {}, {isFocused: !0});
                case"blur":
                    return fe(fe({}, e), {}, {isFocused: !1});
                case"openDialog":
                    return fe(fe({}, ge), {}, {isFileDialogActive: !0});
                case"closeDialog":
                    return fe(fe({}, e), {}, {isFileDialogActive: !1});
                ...
                case"setFiles":
                    return fe(fe({}, e), {}, {acceptedFiles: n.acceptedFiles, fileRejections: n.fileRejections});
                case"reset":
                    return fe({}, ge);
                default:
                    return e
        ...
        var r = t(2791);
        var o = r.forwardRef((function (e, n) {
        ...
        var o = r.forwardRef((function (e, n) {
            return r.createElement("svg", Object.assign({
                ...
                "aria-hidden": "true",
                ref: n
            }, e), r.createElement("path", {d: "M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM14 11a1 1 0 011 1v1h1a1 1 0 110 2h-1v1a1 1 0 11-2 0v-1h-1a1 1 0 110-2h1v-1a1 1 0 011-1z"}))
        }));
        n.Z = o
    }
}]);
//# sourceMappingURL=609.b2b6bc28.chunk.js.map