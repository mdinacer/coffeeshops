...
export default function AppButton({
  ...
  const buttonStateStyle = props.disabled
    ? ' opacity-60 bg-stone-200 text-stone-500 '
...
const buttonStyle =
  ' flex justify-center gap-x-2 items-center  transition-all duration-300 px-3 py-2 text-lg font-Primary font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 ';
